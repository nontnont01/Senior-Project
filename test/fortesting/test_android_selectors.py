...
driver = TestAndroidSelectors().driver('test_should_find_elements_by_accessibility_id')
TestAndroidSelectors().test_should_find_elements_by_accessibility_id(driver)
